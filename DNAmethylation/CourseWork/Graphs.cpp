...
Graphs::Graphs( vector<SortedListOfEdge> graphs )
{
	this->graphs = graphs;
}
...
void Graphs::outGraphs( vector<bool> isSick, string pathOut )
{
...
vector<double> Graphs::getMaxVertexes() const
{
...
vector<double> Graphs::getEfficiencies() const
{
	vector<double> res(graphs.size());
